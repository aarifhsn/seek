                    ...
                    <div class="border rounded border-gray-100/50 dark:border-neutral-600">
                        <div class="p-5 border-b border-gray-100/50 dark:border-neutral-600">
                            <div class="text-center">
                                <img src="{{asset('images/profile.jpg')}}" alt="" class="w-20 h-20 p-1 mx-auto border-2 rounded-full border-gray-200/20">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-center">
                                                    <div class="relative mb-4">
                                                        <img src="{{asset('images/user/img-02.jpg')}}" class="w-40 h-40 p-1 mx-auto border-2 rounded-full border-gray-100/50 dark:border-neutral-600" id="profile-img" alt="">
