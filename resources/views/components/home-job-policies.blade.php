                ...
                <div class="col-span-12 lg:col-span-6">
                    <div class="tab-content">
                        <div class="block tab-pane" id="v-pills-home-tab">
                            <img src="{{asset('images/process-01.png')}}" alt="" class="max-w-full">
                        </div>
                        <div class="hidden tab-pane" id="v-pills-profile">
                            <img src="{{asset('images/process-02.png')}}" alt="" class="max-w-full">
                        </div>
                        <div class="hidden tab-pane" id="v-pills-messages">
                            <img src="{{asset('images/process-03.png')}}" alt="" class="max-w-full">
                        </div>
                    </div>
                </div>
            </div>
