    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-1 gap-5">
            <div class="mb-5 text-center">
                ...
                <p class="mb-5 text-gray-500 whitespace-pre-line dark:text-gray-300">Post a job to tell us about your
                    project. We'll quickly match you with the right <br> freelancers.</p>
            </div>
        </div>
        <div class="nav-tabs chart-tabpill">
                            ...
                            @foreach ($jobTypes as $type)
                                <li class="w-full">
                                    <a href="javascript:void(0);" data-tw-toggle="tab"
                                        data-tw-target="{{ Str::slug($type->value) }}"
                                        class="inline-block w-full py-[12px] px-[18px] dark:text-gray-50">{{ ucfirst($type->value) }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
            ...
            <div class="tab-content">
                ...
                @foreach ($jobTypes as $type)
                    <div class="hidden w-full tab-pane" id="{{ Str::slug($type->value) }}">
                        <div class="pt-8 ">
                            <div class="space-y-8">

                                @foreach ($jobsByType[$type->value] as $job)
